    ...
    <div class="wrapper-left">
        <div class="sidebar-left">
          ...
          <div class="grid-sidebar ">
            ...
            <div class="wrapper-left-elements">
              <a class="wrapper-left-active" href="account.php" style="margin-top: 4px"><strong>Settings</strong></a>
            </div>
      ...
      <div class="grid-posts">
        <div class="border-right">
          ...
          <div class="box-fixed" id="box-fixed" style="background-color: #8e272e;"></div>
                ...
                <div class="tab-content" id="v-pills-tabContent">
                  <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                    ...
                    <?php  if (isset($_SESSION['errors_account'] )) {
                      ...
                      <button type="submit" name="submit" class="btn btn-primary" style="background-color: #8e272e;">Save Changes</button>
