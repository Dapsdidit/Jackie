  ...
  <div  class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <h4 style="font-weight: 600; " >You Signed up Successfully!</h4>
 
        </div>
        <p>This is Jackie made for learning purpose.</p>
        <p>Jackie includes posts , repost , qoute or even qoute the qouted post , like post and nested comments.
          you can mention or add hashtag to your post , change password or username.
    ...
    <div class="wrapper-left">
        <div class="sidebar-left">
          <div class="grid-sidebar" style="margin-top: 12px">
            <div class="icon-sidebar-align">
              <img src="assets/images/jackie.png" alt="" height="50px" width="50px" />
            </div>
          </div>
          ...
          <div class="grid-sidebar bg-active" style="margin-top: 12px">
            <div class="icon-sidebar-align">
              <img src="assets/images/home.png" alt="" height="26.25px" width="26.25px" />
            </div>
          ...
          <button class="button-twittear" style="background-color: #8e272e;">Jackie</button>
      ...
      <div class="grid-posts">
                        ...
                        <div class="bottom"> 
                         ...
                         <?php } } unset($_SESSION['errors_tweet']); ?>
                          <div>
                            ...
                            <input id="tweet-input" type="submit" name="tweet" value="Post" class="submit" style="background-color: #8e272e;">
        ...
        <div class="wrapper-right">
          ...
          <input type="text" class="form-control search-input"  placeholder="Search Jackie">
